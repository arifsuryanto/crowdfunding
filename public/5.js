...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    CampaignItem: function CampaignItem() {
      return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./CampaignItem */ "./resources/js/components/CampaignItem.vue"));
    }
  },
  data: function data() {
    return {
      ...
      _c(
        ...
        [
          _vm.keyword.length > 0
            ? _c("v-subheader", [
                _vm._v(
                  '\n      Result Search "' + _vm._s(_vm.keyword) + '"\n    '
                )
              ])
            : _vm._e(),
          _vm._v(" "),
