    ...
    ? _c(
        ...
        [
                ...
                _c("tbody", [
                  ...
                  _c("tr", [
                    ...
                    _c("td", { staticClass: "blue--text" }, [
                      _vm._v(
                        "\n            Rp. " +
                          _vm._s(_vm.campaign.collected.toLocaleString()) +
                          "\n          "
                      )
                    ])
                  ]),
                  ...
                  _c("tr", [
                    ...
                    _c("td", { staticClass: "orange--text" }, [
                      _vm._v(
                        "\n            Rp.\n            " +
                          _vm._s(_vm.campaign.required.toLocaleString()) +
                          "\n          "
                      )
                    ])
                  ])
          ...
          _c(
            ...
            [
              _c(
                ...
                [_c("v-icon", [_vm._v("mdi-cash")]), _vm._v("   DONATE\n    ")],
                1
              )
            ],
            1
          ...
          _c(
            "v-card-actions",
            [
              _c("v-btn", { attrs: { color: "green lighten-2", text: "" } }, [
                _vm._v(" Description ")
              ]),
              _vm._v(" "),
              _c("v-spacer"),
          ...
          _c("v-expand-transition", [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("v-card-text", {
                  domProps: { textContent: _vm._s(_vm.campaign.description) }
                })
              ],
              1
            )
